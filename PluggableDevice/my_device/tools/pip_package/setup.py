...
# ==============================================================================
'''
setup.py file to build wheel for my_device
'''
...
# MODERNIZATION: Read from environment variable passed by build_pip_package.sh
# instead of relying on custom flags which don't work with 'python -m build'.
project_name = os.environ.get('MY_DEVICE_PROJECT_NAME', 'my_device')
...
class InstallHeaders(Command):
  ...
  def mkdir_and_copy_file(self, header):
    ...
    # No external headers needed for minimal plugin
...
headers = (
    list(find_files('*.h', 'my_device/c_api/c')) +
    list(find_files('*.h', 'my_device/c_api/src')))
