...
#ifndef TENSORFLOW_PLUGIN_SRC_UTILS_LOGGING_H_
#define TENSORFLOW_PLUGIN_SRC_UTILS_LOGGING_H_
...
#include "my_device/src//utils/macros.h"
...
#define _TF_LOG_INFO                                                           \
  ::demo_plugin::internal::LogMessage(__FILE__, __LINE__, ::demo_plugin::INFO)
#define _TF_LOG_WARNING                                                        \
  ::demo_plugin::internal::LogMessage(__FILE__, __LINE__,                      \
                                      ::demo_plugin::WARNING)
#define _TF_LOG_ERROR                                                          \
  ::demo_plugin::internal::LogMessage(__FILE__, __LINE__, ::demo_plugin::ERROR)
#define _TF_LOG_FATAL                                                          \
  ::demo_plugin::internal::LogMessageFatal(__FILE__, __LINE__)
...
#define VLOG_IS_ON(lvl)                                                        \
  (([](int level, const char *fname) {                                         \
    static const bool vmodule_activated =                                      \
        ::demo_plugin::internal::LogMessage::VmoduleActivated(fname, level);   \
...
#define VLOG(level)                                                            \
  ...
  ? (void)0                                                                    \
  : ::demo_plugin::internal::Voidifier() &                                     \
          ::demo_plugin::internal::LogMessage(__FILE__, __LINE__,              \
                                              demo_plugin::INFO)
...
#define DVLOG(verbose_level)                                                   \
  ...
  ::demo_plugin::internal::LogMessageNull()
#endif
...
#define LOGGING_INTERNAL_STATEFUL_CONDITION(kind, condition, arg)              \
  for (bool logging_internal_stateful_condition_do_log(condition);             \
    ...
    for (static ::demo_plugin::internal::Log##kind##State                      \
...
#define TF_DEFINE_CHECK_OP_IMPL(name, op)                                      \
  ...
  inline string *name##Impl(const T1 &v1, const T2 &v2,                        \
    ...
    if (TF_PREDICT_TRUE(v1 op v2))                                             \
      ...
      return ::demo_plugin::internal::MakeCheckOpString(v1, v2, exprtext);     \
  }                                                                            \
...
#define CHECK_OP_LOG(name, op, val1, val2)                                     \
  while (::demo_plugin::internal::CheckOpString _result{                       \
      ::demo_plugin::internal::name##Impl(                                     \
          ::demo_plugin::internal::GetReferenceableValue(val1),                \
          ::demo_plugin::internal::GetReferenceableValue(val2),                \
          #val1 " " #op " " #val2)})                                           \
  ::demo_plugin::internal::LogMessageFatal(__FILE__, __LINE__)                 \
      << *(_result.str_)
...
#define CHECK_NOTNULL(val)                                                     \
  ::demo_plugin::internal::CheckNotNull(__FILE__, __LINE__,                    \
...
#endif // TENSORFLOW_PLUGIN_SRC_UTILS_LOGGING_H_
