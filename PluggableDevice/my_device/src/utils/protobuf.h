...
#ifndef TENSORFLOW_PLUGIN_SRC_UTILS_PROTOBUF_H_
#define TENSORFLOW_PLUGIN_SRC_UTILS_PROTOBUF_H_

#include "my_device/src/utils/platform.h"
...
#endif // TENSORFLOW_PLUGIN_SRC_UTILS_PROTOBUF_H_
