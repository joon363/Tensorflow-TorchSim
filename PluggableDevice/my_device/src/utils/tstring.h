...
#ifndef TENSORFLOW_PLUGIN_SRC_UTILS_TSTRING_H_
#define TENSORFLOW_PLUGIN_SRC_UTILS_TSTRING_H_

#include <assert.h>
#include <ostream>
#include <string>

#include "my_device/src/utils/ctstring.h"

// TODO(intel-tf): This include is temporary, and will be superfluous once
...
#endif // TENSORFLOW_PLUGIN_SRC_UTILS_TSTRING_H_
