...
#ifndef TENSORFLOW_PLUGIN_SRC_UTILS_GTL_FLATREP_H_
#define TENSORFLOW_PLUGIN_SRC_UTILS_GTL_FLATREP_H_

#include <string.h>
#include <utility>
#include "my_device/src/utils/prefetch.h"
...
#endif  // TENSORFLOW_PLUGIN_SRC_UTILS_GTL_FLATREP_H_
